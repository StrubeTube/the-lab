...
(function () {
    ...
    const body = el('div', {},
      ...
      p.lab ? (() => {
        ...
        return el('div', { style: 'margin-top:12px' },
          ...
          line('Contract', L2.apy != null ? `$${L2.apy}M/yr · under team control through ${L2.cfa}` : null,
            L2.apy >= 15 ? 'good' : L2.apy < 2 ? 'muted' : '',
            'live OverTheCap data — real money committed is how seriously the team takes his role; rookie deals show small money but draft capital covers that'),
  ...
  LAB.nav = function (active) {
    const links = [
      ...
      ['draftmap.html', 'Draft Map'], ['picks.html', 'Pick Sheet'], ['trade.html', 'Trades'], ['finder.html', 'Finder'], ['keepers.html', 'Keepers'], ['season.html', 'Season'], ['sos.html', 'SoS'],
    ];
